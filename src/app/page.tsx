            ...
            <div className="container mx-auto p-4 relative">
                <div className="bg-white border-2 border-purple-100 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col justify-center">
                        ...
                        <a href="/blog/posts" className="outline outline-offset-2 border-purple-700 text-purple-700 hover:text-white py-2 px-4 rounded hover:bg-purple-800 md:w-auto">
                          Go to Blog
                        </a>
                    </div>
                </div>
